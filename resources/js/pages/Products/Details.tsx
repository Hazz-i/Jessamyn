...
export default function ProductDetails() {
    ...
    const handleVariantUpdate = (updatedVariant: any) => {
        setProduct((prev: any) => ({
            ...prev,
            variants: prev.variants.map((v: any) => (v.id === updatedVariant.id ? updatedVariant : v)),
        }));
        setEditOpen(false);
    };
                ...
                <div className="grid w-full max-w-6xl grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-start gap-6">
                        ...
                        <div className="flex gap-2">
                            ...
                            <p className="text-sm">{selectedVariant?.stock_qty ?? product?.stock ?? 0}</p>
                        </div>
                        ...
                        <div>
                            ...
                            {selectedVariant ? (
                                <p className="text-xl font-medium text-primary">Rp {Number(selectedVariant.price).toLocaleString('id-ID')}</p>
                            ) : product?.price ? (
                                <p className="text-xl font-medium text-primary">Rp {Number(product.price).toLocaleString('id-ID')}</p>
                            ) : (
